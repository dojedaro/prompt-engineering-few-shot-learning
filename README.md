...
Rather than optimizing for peak model performance, the goal of this project is to demonstrate **systematic experiment design, evaluation methodology, and analysis skills** when working with LLMs.
